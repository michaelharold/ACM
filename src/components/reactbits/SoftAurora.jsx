...
export default function SoftAurora({
  ...
  useEffect(() => {
    ...
    // The upstream component only listens to window resize. This section's
    // height changes when images load or the admin adds photos, so observe the
    // container too — otherwise the canvas keeps a stale size and stretches.
    let ro;
